...
input { # I use fcitz5 instead of this anyway
    kb_layout = us, bg
...
# Screenshot
bind = , Print, exec, grimblast --freeze copysave area ~/Pictures/$(date +%Y-%m-%d_%H-%m-%s).png
bind = SHIFT, Print, exec, grimblast copysave active ~/Pictures/$(date +%Y-%m-%d_%H-%m-%s).png
